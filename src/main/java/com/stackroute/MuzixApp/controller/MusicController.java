...
public void setMusicService(MusicService musicService){
    ...
    @ApiOperation(value = "Saves the track in the Database")
    ...
    @ApiOperation(value = "Gets all the tracks from the Database")
    ...
    @ApiOperation(value = "Updates the comments of the track")
    ...
    @ApiOperation(value = "Deletes the track from Database")
    ...
    @ApiOperation(value = "Gets the track by name")
